				...
				>
					...
					<span slot="action" slot-scope="record">
						...
						<router-link
							...
							style="color: #1890ff"
							:to="{ path: '/planaudit', query: { id: record.id, type: 0 } }"
							>查看</router-link
						>
						<router-link
							v-else
							style="color: #1890ff"
							:to="{ path: '/planedit', query: { id: record.id, type: 0 } }"
							>查看</router-link
						>
						...
						<router-link
							...
							style="color: #1890ff"
							:to="{ path: '/planedit', query: { id: record.id, type: 1 } }"
							>修改</router-link
						>
						<a-divider v-if="record.status === 0" type="vertical" />
						<a
						...
						<router-link
							...
							style="color: #1890ff"
							:to="{ path: '/planaudit', query: { id: record.id, type: 1 } }"
							>审核</router-link
						>
					</span>
				</a-table>
